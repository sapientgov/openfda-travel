...
Note: There are known issues with Internet Explorer relating to the login functionality. Full functionality can be enjoyed in Chrome and Firefox.
...
- [Threat Modeling Report](docs/18f_threat_assessment.html)
...
| C | Citation in Our Approach. |
| D | Citation in Our Approach. |
...
| N | We conducted a threat assessment ([18f_threat_assessment.html](docs/18f_threat_assessment.html)), which is an example of a security impact analysis. An example of the vulnerability report generated by a web application vulnerability scanner of FDA Anywhere can be found [here](docs/vuln_scan_generated_report).|
